...
<table>
	...
	<tr>
		<td>Verkauf:</td>
		<td>
			<input type='radio' name='sale' value='for sale' "; echo ($sale=='for sale'? "checked='checked'" : ""); echo">zu verkaufen<br>
			<input type='radio' name='sale' value='sold' "; echo ($sale=='sold'? "checked='checked'" : ""); echo ">verkauft<br>
		</td>
	</tr>
	<tr>
